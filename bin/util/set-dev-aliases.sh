...
alias startnginx='$CEDAR_UTIL_BIN/service/startnginx.sh'
alias stopnginx='$CEDAR_UTIL_BIN/service/stopnginx.sh'

alias startkk='$CEDAR_UTIL_BIN/service/startkeycloak.sh'
alias killkk='$CEDAR_UTIL_BIN/service/killkeycloak.sh'

alias startmongo='$CEDAR_UTIL_BIN/service/startmongo.sh'
alias stopmongo='$CEDAR_UTIL_BIN/service/stopmongo.sh'

alias startmysql='$CEDAR_UTIL_BIN/service/startmysql.sh'
alias stopmysql='$CEDAR_UTIL_BIN/service/stopmysql.sh'

alias startkibana='$CEDAR_UTIL_BIN/service/startkibana.sh'
alias stopkibana='$CEDAR_UTIL_BIN/service/stopkibana.sh'

alias startelastic='$CEDAR_UTIL_BIN/service/startelastic.sh'
alias stopelastic='$CEDAR_UTIL_BIN/service/stopelastic.sh'

alias startneo='$CEDAR_UTIL_BIN/service/startneo.sh'
alias stopneo='$CEDAR_UTIL_BIN/service/stopneo.sh'

alias startredis='$CEDAR_UTIL_BIN/service/startredis.sh'
alias stopredis='$CEDAR_UTIL_BIN/service/stopredis.sh'

alias startrc='$CEDAR_UTIL_BIN/service/startrediscommander.sh'
alias killrc='$CEDAR_UTIL_BIN/service/killrediscommander.sh'
