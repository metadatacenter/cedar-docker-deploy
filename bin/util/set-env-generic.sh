...
#CEDAR version
export CEDAR_VERSION=2.4.10-SNAPSHOT
...
export CEDAR_OPEN_HTTP_PORT=9013
export CEDAR_OPEN_ADMIN_PORT=$((${CEDAR_OPEN_HTTP_PORT} + 100))
export CEDAR_OPEN_STOP_PORT=$((${CEDAR_OPEN_HTTP_PORT} + 200))
