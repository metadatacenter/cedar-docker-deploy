...
#CEDAR version
export CEDAR_VERSION=2.2.4-SNAPSHOT
...
export CEDAR_FAIRDATA_HTTP_PORT=9013
export CEDAR_FAIRDATA_ADMIN_PORT=$((${CEDAR_FAIRDATA_HTTP_PORT} + 100))
export CEDAR_FAIRDATA_STOP_PORT=$((${CEDAR_FAIRDATA_HTTP_PORT} + 200))
